...
import '../application/profile/profile_bloc.dart' as _i7;
import '../application/register/register_bloc.dart' as _i12;
import '../domain/auth/auth_repository.dart' as _i9;
import '../domain/profle/profile_repository.dart' as _i8;
...
import 'registed_modules.dart' as _i14; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i7.ProfileBloc>(
      () => _i7.ProfileBloc(get<_i8.ProfileRepository>()));
  ...
  gh.factory<_i12.RegisterBloc>(
      () => _i12.RegisterBloc(get<_i9.AuthRepository>()));
  gh.factory<_i13.AuthBloc>(() => _i13.AuthBloc(get<_i9.AuthRepository>()));
  return get;
}
